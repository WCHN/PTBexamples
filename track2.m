...
%
% Starts and stops recording on a per trial basis
%
...
triallen = 6;
ITI = 2;
edf_filename = 'track2'; % the filename must be 8 characters or less & no spaces!
...
disp(['Scan start @ time ' num2str(t0)])        % display timestamp & volume number


%% Trial loop
for trial = 1:ntrials
    ret_val = Eyelink('StartRecording');        % start recording
